...
\ganttgroup[group left shift=0.0, group right shift=-0.0, name=uniqueid1]{Something [1/4]}{2015-05-29}{2015-06-22}\\
  ...
  \ganttbar[bar left shift=0.0, bar right shift=0, name=uniqueid3]{don't bother}{2015-05-15}{2015-05-15}\\
  \ganttbar[bar left shift=0.0, bar right shift=0, name=uniqueid4]{one}{2015-05-15}{2015-05-15}\\
  \ganttbar[bar left shift=0.0, bar right shift=0, name=uniqueid5]{two}{2015-05-15}{2015-05-15}\\
